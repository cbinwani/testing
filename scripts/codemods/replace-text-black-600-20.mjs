 ...
 *
 * Usage:
 *   node nexxonn/scripts/codemods/replace-text-black-600-20.mjs
 *   node nexxonn/scripts/codemods/replace-text-black-600-20.mjs --apply
 *   node nexxonn/scripts/codemods/replace-text-black-600-20.mjs --root . --apply
 *   node nexxonn/scripts/codemods/replace-text-black-600-20.mjs --ext ts,tsx,jsx,css --apply
 *
 * Notes:
...
Examples:
  node nexxonn/scripts/codemods/replace-text-black-600-20.mjs
  node nexxonn/scripts/codemods/replace-text-black-600-20.mjs --apply
  node nexxonn/scripts/codemods/replace-text-black-600-20.mjs --root . --ext ts,tsx,jsx,css --apply
`);
}
