 ...
 *
 * Usage:
 *   node nexxonn/scripts/codemods/replace-text-white-900-to-inverse.mjs
 *   node nexxonn/scripts/codemods/replace-text-white-900-to-inverse.mjs --apply
 *   node nexxonn/scripts/codemods/replace-text-white-900-to-inverse.mjs --root . --apply
 *   node nexxonn/scripts/codemods/replace-text-white-900-to-inverse.mjs --ext ts,tsx,jsx,css --apply
 *
 * Notes:
...
Examples:
  node nexxonn/scripts/codemods/replace-text-white-900-to-inverse.mjs
  node nexxonn/scripts/codemods/replace-text-white-900-to-inverse.mjs --apply
  node nexxonn/scripts/codemods/replace-text-white-900-to-inverse.mjs --root . --ext ts,tsx,jsx,css --apply
`);
}
