...
Email templates for Nexxonn using [React Email](https://react.email/).
...
```bash
pnpm -F studio.nexxonn.ai email:dev
```
...
- Store shared images in `apps/studio.nexxonn.ai/public/emails`. These files are served from `/emails/*` in production emails.
...
- `EmailHeader` and `EmailFooter` already include the Nexxonn logo, footer logo, and social icons using `getEmailAssetUrl`. Just render them without props—no need to pass URLs or hosts.
...
```bash
pnpm -F studio.nexxonn.ai email:export
```
...
### 📘 Nexxonn Email Style Guide v1

#### 🌐 Overview

Nexxonn marketing emails are designed with the purpose of:
...
| Logo | Nexxonn logo at top center | Size 32–40px |
...
| Reactivation | Warm × Personal | ⚪ Short | Return to Nexxonn | Promote return, reuse |
...
- **Subject**: Welcome to Nexxonn — your AI workspace starts here 🪶
- **Header**: Welcome to Nexxonn. / Your journey to build AI agents begins here.
...
- **Subject**: Nexxonn now supports Gemini 2.5 Flash 🚀
- **Header**: New in Nexxonn. / Smarter, faster, and more connected than ever.
...
- **Subject**: Join the Nexxonn Ambassador Program 🪶
- **Header**: Let's grow together. / Become a Nexxonn Ambassador.
...
- **Subject**: We've missed you at Nexxonn 💫
...
- **CTA**: [Return to Nexxonn]

**🎉 Special → year-in-review**

- **Subject**: Your 2025 journey with Nexxonn ✨
- **Header**: A year of creation. / Thank you for building with us.
- **Body**: This year, thousands of agents were created in Nexxonn — and you were part of it. Here's a look back at your milestones and what's coming next.
...
4. Copyright: `© {current year} Nexxonn`
5. Explanation text: "You received this email because you signed up for Nexxonn—a platform for building AI agents."

**Links:**
- Product: `https://studio.nexxonn.ai`
- Blog: `https://nexxonn.ai/blog`
- Documentation: `https://docs.nexxonn.ai/en/guides/introduction`

**Social Media Links:**
- GitHub: `https://github.com/nexxonn-ai/nexxonn`
- LinkedIn: `https://www.linkedin.com/showcase/nexxonn-ai/`
- Facebook: `https://www.facebook.com/NexxonnAI/`
- X: `https://x.com/Nexxonn_AI`
- Instagram: `https://www.instagram.com/nexxonn_de_ai`
- YouTube: `https://www.youtube.com/@Nexxonn_AI`
...
> "Every email from Nexxonn should feel like a calm, confident nudge — not a shout."

### Creating Marketing Email Templates

1. Create a new template file in `apps/studio.nexxonn.ai/emails/marketing/`
...
const html = render(
  <NewsletterEmail
    userName="John Doe"
    unsubscribeUrl="https://nexxonn.ai/unsubscribe"
  />
);
