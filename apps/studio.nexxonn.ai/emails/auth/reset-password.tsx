...
export const ResetPasswordEmail = ({
	...
	return (
		<Html>
			...
			<Preview>Reset your Nexxonn password</Preview>
			<Body style={main}>
				<Container style={container}>
					<EmailHeader
						heading="Reset your Nexxonn password."
					...
					<Section style={section}>
						<Text style={text}>
							We received a request to reset your Nexxonn account password.
						</Text>
						<Text style={text}>
...
ResetPasswordEmail.PreviewProps = {
	siteUrl: "https://studio.nexxonn.ai",
