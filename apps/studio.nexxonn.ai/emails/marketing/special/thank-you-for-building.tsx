...
export const ThankYouForBuildingEmail = ({
	continueBuildingUrl = "https://studio.nexxonn.ai",
	...
	return (
		<Html>
			...
			<Preview>Thank you for building with Nexxonn</Preview>
			<Body style={main}>
				<Container style={container}>
					...
					<Section style={section}>
						<Heading style={h1}>Thank You for Building with Nexxonn.</Heading>
						<Text style={text}>
