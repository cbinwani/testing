...
interface YearInReviewEmailProps {
	viewYearInNexxonnUrl?: string;
}

export const YearInReviewEmail = ({
	viewYearInNexxonnUrl = "https://studio.nexxonn.ai/year-in-review",
			...
			<Body style={main}>
				<Container style={container}>
					...
					<Section style={section}>
						...
						<Button href={viewYearInNexxonnUrl} style={button}>
							View Your Year in Nexxonn →
						</Button>
					</Section>
