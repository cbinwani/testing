...
export const ChangelogAnnouncementEmail = ({
	...
	screenshotUrl,
	viewChangelogUrl = "https://nexxonn.ai/changelog",
}: ChangelogAnnouncementEmailProps) => {
	const headerBannerSrc = getEmailAssetUrl("nexxonntimes.png");
	return (
		<Html>
			<Head>
				<EmailFonts />
			</Head>
			<Preview>Nexxonn update</Preview>
			<Body style={main}>
				<Container style={container}>
					...
					<Section style={titleSection}>
						<Row>
							<Column style={titleLeftColumn}>
								<Text style={copyrightText}>©️2025 Nexxonn</Text>
							</Column>
					...
					<Section style={section}>
						...
						<Text style={text}>
							As always, your feedback helps us refine Nexxonn.
						</Text>
