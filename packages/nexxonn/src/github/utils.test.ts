...
describe("parseGitHubUrl", () => {
	...
	test("should parse issue URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/nexxonn-ai/nexxonn/issues/9",
		);
	...
	test("should parse issue comment URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/nexxonn-ai/nexxonn/issues/9#issuecomment-2708745880",
		);
		expect(result).toEqual({
			owner: "nexxonn-ai",
			repo: "nexxonn",
	...
	test("should parse pull request URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/nexxonn-ai/nexxonn/pull/403",
		);
		expect(result).toEqual({
			owner: "nexxonn-ai",
			repo: "nexxonn",
	...
	test("should parse pull request review comment URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/nexxonn-ai/nexxonn/pull/403#discussion_r1984371481",
		);
		expect(result).toEqual({
			owner: "nexxonn-ai",
			repo: "nexxonn",
	...
	test("should parse release URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/nexxonn-ai/nexxonn/releases/tag/studio.nexxonn.ai%400.7.0",
		);
		expect(result).toEqual({
			owner: "nexxonn-ai",
			repo: "nexxonn",
			type: "release",
			tagName: "studio.nexxonn.ai@0.7.0",
		});
	});
	...
	test("should parse discussion URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/nexxonn-ai/nexxonn/discussions/385",
		);
		expect(result).toEqual({
			owner: "nexxonn-ai",
			repo: "nexxonn",
	...
	test("should parse discussion comment URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/nexxonn-ai/nexxonn/discussions/336#discussioncomment-12181977",
		);
		expect(result).toEqual({
			owner: "nexxonn-ai",
			repo: "nexxonn",
	...
	test("should parse tree URL with branch and path", () => {
		const result = parseGitHubUrl(
			"https://github.com/nexxonn-ai/nexxonn/tree/main/apps/playground",
		);
		expect(result).toEqual({
			owner: "nexxonn-ai",
			repo: "nexxonn",
	...
	test("should parse tree URL with commit hash and path", () => {
		const result = parseGitHubUrl(
			"https://github.com/nexxonn-ai/nexxonn/tree/0e4b541c3296c67adb279fd2e4805113e79f972a/apps/playground",
		);
		expect(result).toEqual({
			owner: "nexxonn-ai",
			repo: "nexxonn",
	...
	test("should parse commit URL", () => {
		const result = parseGitHubUrl(
			"https://github.com/nexxonn-ai/nexxonn/commit/0e4b541c3296c67adb279fd2e4805113e79f972a",
		);
		expect(result).toEqual({
			owner: "nexxonn-ai",
			repo: "nexxonn",
	...
	test("should handle repository root URL", () => {
		const result = parseGitHubUrl("https://github.com/nexxonn-ai/nexxonn");
		expect(result).toEqual({
			owner: "nexxonn-ai",
			repo: "nexxonn",
			type: "tree",
...
test("invalid command format returns null", () => {
	...
	expect(parseCommand("nexxonn hello")).toBe(null);
});

test("command with multiple spaces", () => {
	expect(parseCommand("/nexxonn    hello   some content")).toStrictEqual({
		callsign: "nexxonn",
...
test("command with no empty line after command", () => {
	expect(parseCommand("/nexxonn hello content")).toStrictEqual({
		callsign: "nexxonn",
