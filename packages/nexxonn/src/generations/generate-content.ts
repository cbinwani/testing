...
import { githubTools, octokit } from "@nexxonn-ai/github-tool";
import {
	Capability,
	hasCapability,
	languageModels,
} from "@nexxonn-ai/language-model";
import type {
	CompletedGeneration,
	FailedGeneration,
	GenerationOutput,
...
import type { AiGatewayHeaders, NexxonnContext } from "../types";
...
import { transformNexxonnLanguageModelToAiSdkLanguageModelCallOptions } from "./v2/language-model";
...
function generateContentV2({
	...
	return useGenerationExecutor({
		...
		execute: async ({
			...
			const callOptions =
				transformNexxonnLanguageModelToAiSdkLanguageModelCallOptions(
