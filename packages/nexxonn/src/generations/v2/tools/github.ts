import type { Octokit } from "@nexxonn-ai/github-tool";
import type { Tool } from "@nexxonn-ai/language-model-registry";
import { hasSchema } from "@nexxonn-ai/language-model-registry";
