import { hasTierAccess, languageModels } from "@nexxonn-ai/language-model";
import {
...
import {
	isJsonContent,
	jsonContentToText,
} from "@nexxonn-ai/text-editor-utils";
...
export async function handleAgentTimeConsumption(args: {
	...
	onConsumeAgentTime?: NonNullable<NexxonnContext["onConsumeAgentTime"]>;
}) {
...
export async function checkUsageLimits(args: {
	workspaceId: WorkspaceId;
	generation: Generation;
	fetchUsageLimitsFn?: NonNullable<NexxonnContext["fetchUsageLimitsFn"]>;
