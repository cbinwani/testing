...
This package is intended for internal use within the Nexxonn monorepo. If you want to use it elsewhere, install dependencies:
...
```ts
import { webSearch } from "@nexxonn-ai/web-search";
