...
import { isAppEntryNode, isEndNode, type NodeId } from "@nexxonn-ai/protocol";
import {
	type Connection,
	type Edge,
...
import { isSupportedConnection } from "@nexxonn-ai/react";
...
function V2NodeCanvas() {
	...
	return (
		<ReactFlow
			ref={reactFlowRef}
			className="nexxonn-workflow-editor-v3"
			colorMode="dark"
