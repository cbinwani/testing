...
export function ChatPanel() {
	...
	const demoMessages = [
		// Long message
		"Thanks for your question! I'll help you with that. For more information about nodes, check out our documentation at https://docs.nexxonn.ai/en/glossary/node or visit our GitHub repository at https://github.com/nexxonn-ai/nexxonn for examples. You can also explore different node types, configure their settings, and connect them to build powerful workflows. Feel free to experiment with the visual editor and don't hesitate to ask if you need guidance!",
		// Short message
		"Got it! Check our docs at https://docs.nexxonn.ai/en/glossary/node for more info.",
		// Greeting message
