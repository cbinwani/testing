...
export const tourSteps: TourStep[] = [
	...
	},
	{
		...
		content:
			"Get help when you need it. Explore our <a href='https://docs.nexxonn.ai/en' target='_blank' class='text-primary-200 hover:underline'>comprehensive Docs</a> for detailed guidance and best practices whenever you encounter challenges.",
		placement: "bottom" as const,
	},
];
