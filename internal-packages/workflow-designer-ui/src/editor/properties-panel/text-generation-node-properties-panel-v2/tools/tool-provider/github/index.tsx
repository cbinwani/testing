...
import { Input } from "@nexxonn-internal/ui/input";
import { Select } from "@nexxonn-internal/ui/select";
import type { ContentGenerationNode } from "@nexxonn-ai/protocol";
import {
	CheckIcon,
	MoveUpRightIcon,
	PlusIcon,
							...
							<div className="flex flex-col gap-1 border border-border-variant rounded-[4px] overflow-hidden">
								{category.tools.map((tool) => (
									...
									>
										...
										<DocsLink
											href={`https://docs.nexxonn.ai/en/glossary/github-tools#${encodeURIComponent(
												tool.toLowerCase(),
											)}`}
											target="_blank"
											rel="noopener noreferrer"
