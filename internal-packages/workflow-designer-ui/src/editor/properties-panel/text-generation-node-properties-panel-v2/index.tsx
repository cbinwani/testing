...
import type { LanguageModelTier } from "@nexxonn-ai/language-model-registry";
import { convertContentGenerationToTextGeneration } from "@nexxonn-ai/node-registry";
import {
	type Connection,
...
import { useNodeGenerations, useUsageLimits } from "@nexxonn-ai/react";
	...
	return (
		<PropertiesPanelRoot>
			...
			<NodePanelHeader
				...
				docsUrl="https://docs.nexxonn.ai/en/glossary/text-node"
